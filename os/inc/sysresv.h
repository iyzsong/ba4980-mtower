...
#define		GUI_APP_ID_EC_DICT_SJ		0x0000
#define		GUI_APP_ID_EC_DICT_SW		0x0001
#define		GUI_APP_ID_CE_DICT			0x0002
#define		GUI_APP_ID_DLG				0x0100
#define		GUI_APP_ID_DOWN_LOAD		0x0402

#define		GUI_APP_ID_CARD				0x0800

#define		HOME_ID_DATA				4			/* 模块在 主目录顺序号 */
#define		HOME_ID_GAME				5
#define		HOME_ID_MEMO				9
