...
#define		CAHR_ENG_TONE			CHAR_ADDRESS
#define		CHAR_AMR_TONE			CHAR_TIME
#define		CHAR_TRD_TONE			CHAR_DOWNLOAD
#define		CHAR_SPL_TONE			CHAR_SPK
...
#define		KEY_ENG_TONE			KEY_ADDRESS
#define		KEY_AMR_TONE			KEY_TIME
#define		KEY_TRD_TONE			KEY_DOWNLOAD
#define		KEY_SPL_TONE			KEY_SPK

#define		KEY_EC_DICT				KEY_EC_SJ
#define		KEY_CE_DICT				KEY_EC_SW
#define		KEY_ADDRESS				KEY_DLG
#define		KEY_TIME				KEY_DOWNLOAD
